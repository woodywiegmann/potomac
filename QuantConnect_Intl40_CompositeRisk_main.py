# QUANTCONNECT ALGORITHM LAB - COPY THIS ENTIRE FILE INTO main.py
# 40-ETF Dual Momentum + Composite Risk-On/Risk-Off (breadth, ACWX, RSI5, WMA/IWMA, Turtle)
# Then click Backtest in QuantConnect.
